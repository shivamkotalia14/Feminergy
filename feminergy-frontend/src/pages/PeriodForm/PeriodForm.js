...
const Consult = () => {
  const [name, setName] = useState('');
    ...
    return (
      ...
      <div className='consult'>
        ...
        <div className="Shivam">
            <h2 className='hgn'>Period Tracker</h2>
    ...
    <div className="Shivam-group">
        <label className="Shivam-label">Bleeding Type for Day3: </label>
        <div>
            <input type="radio" id="noBleeding" name="bleedingType" value="noBleeding" onChange={(e) => setBleedingType(e.target.value)} />
            <label htmlFor="noBleeding">No Bleeding</label>
        </div>
    ...
    <div className="Shivam-group">
        <label className="Shivam-label">Bleeding Type for Day4: </label>
        <div>
            <input type="radio" id="noBleeding" name="bleedingType" value="noBleeding" onChange={(e) => setBleedingType(e.target.value)} />
            <label htmlFor="noBleeding">No Bleeding</label>
        </div>
    ...
    <div className="Shivam-group">
        <label className="Shivam-label">Bleeding Type for Day5: </label>
        <div>
            <input type="radio" id="noBleeding" name="bleedingType" value="noBleeding" onChange={(e) => setBleedingType(e.target.value)} />
            <label htmlFor="noBleeding">No Bleeding</label>
        </div>
    ...
    <div className="Shivam-group">
        <label className="Shivam-label">Bleeding Type for Day6: </label>
        <div>
            <input type="radio" id="noBleeding" name="bleedingType" value="noBleeding" onChange={(e) => setBleedingType(e.target.value)} />
            <label htmlFor="noBleeding">No Bleeding</label>
        </div>
    ...
    <div className="Shivam-group">
        <label className="Shivam-label">Bleeding Type for Day7: </label>
        <div>
            <input type="radio" id="noBleeding" name="bleedingType" value="noBleeding" onChange={(e) => setBleedingType(e.target.value)} />
            <label htmlFor="noBleeding">No Bleeding</label>
        </div>
